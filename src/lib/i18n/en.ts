...
export const en: Translations = {
  ...
  schedule: {
    ...
    enabled: 'Enabled',
    statusEnabled: 'Click to pause automatic playback',
    statusDisabled: 'Click to enable automatic playback',
  ...
  settings: {
    ...
    update: {
      ...
      restartRequired: 'Restart to complete update',
  ...
  tts: {
    ...
    connectionOnline: 'Online - using ElevenLabs API',
    connectionOffline: 'Offline - can only play local files',
    text: 'Text',
